 ...
 * @author Windows 7
 */
public class VendasV extends javax.swing.JFrame {

    /**
     * Creates new form VendasV
     */
    public VendasV() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendasV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 private void imprimir(){
      ...
      if (d.equals("  /  /  ")){
        ...
        String Comando = "insert into vendass(nomef,nomec,cpfc,modelo,marca,cor,placa,valor,data,status) values"+"('"+nf+"','"+nc+"','"+cpfc+"','"+m+"','"+ma+"','"+c+"','"+p+"',"+v+",'"+d+"','"+s+"');";
        String Comando1 = "update veiculo set status = '"+s+"' where codv="+codv;
   ...
   private void buscarv(){
    ...
    if (!Comando3.equals("")){
        try{
            ...
            Logger.getLogger(VendasV.class.getName()).log(Level.SEVERE,null,ex);
